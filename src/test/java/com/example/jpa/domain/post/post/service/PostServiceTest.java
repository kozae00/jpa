...
public class PostServiceTest {
    ...
    void t10() {
        ...
        // SELECT * FROM post WHERE title LIKE 'title%' ORDER BY id DESC LIMIT 10;
    ...
    void t12() {
        ...
        // post를 먼저 조회해서 member id를 알아온 후 -> member 조회 -> select 2번 조회

        // 대부분의 경우 JPA는 연관된 정보를 가져올 때 select를 여러번 남긴다.
